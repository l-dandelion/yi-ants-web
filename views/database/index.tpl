...
<article class="page-container">
	<form action="/database/table" method="get" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>数据段长度：</label>
            <div class="formControls col-xs-2 col-sm-2">
                <input type="text" class="input-text" value="" placeholder="" id="limit" name="limit">
            </div>
        </div>
		<div class="row cl">
