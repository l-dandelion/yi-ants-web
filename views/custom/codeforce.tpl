...
<form action="/api/custom/codeforce" method="get" class="form form-horizontal" id="form-member-add">
<div class="row cl">
...
<div class="formControls col-xs-2 col-sm-2">
<input type="text" class="input-text" value="" placeholder="kbnzlevy|petr" name="usernames">
</div>
</div>
<div class="row cl">
